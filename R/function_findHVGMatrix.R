########################################################################################
## Title: function_findHVGMatrix.R
...
#' @param mat Matrix to use for finding HVG.
...
#' @param spikeins Logical vector stating whether each gene is spike or not. Only used when
#' UseSpike=TRUE.
...
#' @export
findHVGMatrix <- function(mat, signThres=0.1, outputPlots="./",plotting="pdf",
                   colVarGenes="deeppink",UseSpike=TRUE, spikeins=NULL,
